...
using BladesLib.Images;
using BladesLib.Input;
using BladesLib.Screens;

namespace BladesLib.Gui
{
    public class Button
    {
        /// <summary>
        ...
        public void Update(GameTime gameTime)
        {
            ...
            Point location = new Point(InputManager.Instance.MousePosition.X + ScreenManager.Instance.Camera.WorldPosition.X, InputManager.Instance.MousePosition.Y + ScreenManager.Instance.Camera.WorldPosition.Y);
