...
namespace BladesLib.Input
{
    ...
    public class InputManager
    {
        ...
        public Point MousePosition { get { return new Point(_currentMouseState.X  - ScreenManager.Instance.Camera.WorldPosition.X, _currentMouseState.Y - ScreenManager.Instance.Camera.WorldPosition.Y); } }
